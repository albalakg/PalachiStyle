  ...
  <section id="home" class="min-h-screen relative overflow-hidden flex items-center">
    ...
    <div class="container mx-auto px-4 py-20 relative">
      <div class="text-white max-w-4xl">
          <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">עיצוב שיער עד הבית - Palachi</h1>
          <h2 class="text-2xl md:text-4xl font-bold mb-6 leading-tight">שיער זה לא רק מראה – זו תחושת ביטחון</h2>
          <p class="text-xl mb-8 text-gray-200">
            נעים להכיר, אני שחר, מעצבת שיער עם ניסיון של מעל 9 שנים בתחום, והיום אני מביאה את הסלון עד אלייך הביתה.
          ...
          <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 sm:space-x-reverse">
            <a href="#contact" class="bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 text-white px-20 py-4 text-lg rounded-full hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-center">קבעי תור</a>
            <a href="#services" class="bg-white/10 text-white px-20 py-4 text-lg rounded-full hover:bg-white/20 transition-colors backdrop-blur-sm text-center">גלי עוד</a>
        </div>
      </div>
    </div>
  </section>
