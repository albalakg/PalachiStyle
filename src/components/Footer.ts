export const Footer = `
  <footer class="fixed bottom-0 right-0 left-0 bg-white lg:hidden">
    <div class="flex justify-around">
      <div class="flex flex-1 py-2 justify-center bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 ">
        <a href="tel:+052-2427530" class="flex flex-col items-center text-white">
          <i class="fas fa-phone mb-1"></i>
          <span class="text-sm">התקשרי</span>
        </a>
      </div>

      <div class="flex flex-1 py-2 justify-center">
        <a href="#home" class="text-primary-500 flex flex-col items-center">
          <i class="fas fa-arrow-up mb-1"></i>
          <span class="text-sm">חזרה למעלה</span>
        </a>
      </div>
    </div>
  </footer>
