    ...
    <nav class="container mx-auto px-4 py-4">
      <div class="flex justify-between items-center lg:justify-center lg:gap-20">
        ...
        <ul id="menuItems" class="hidden lg:flex items-center gap-5 text-gray-600">
          <li><a href="#home" class="text-white hover:text-primary-500 transition-colors px-6 py-3 text-lg">בית</a></li>
          <li><a href="#services" class="text-white hover:text-primary-500 transition-colors px-6 py-3 text-lg">שירותים</a></li>
          <li><a href="#gallery" class="text-white hover:text-primary-500 transition-colors px-6 py-3 text-lg">גלריה</a></li>
          <li><a href="#pricing" class="text-white hover:text-primary-500 transition-colors px-6 py-3 text-lg">מחירון</a></li>
          <li>
